...
export default function ChatAssistant() {
    ...
    return (
        <section className="relative overflow-hidden rounded-3xl border border-gold-500/20 bg-gradient-to-br from-gray-950 via-black/90 to-gray-900/80 shadow-[0_24px_60px_rgba(0,0,0,0.55)]">
            ...
            <div className="relative flex flex-col gap-6 px-6 py-6 sm:px-8 sm:py-8">
                ...
                <div className="grid gap-4 lg:grid-cols-[minmax(0,2fr)_minmax(0,1fr)]">
                    <div className="flex h-[520px] flex-col rounded-2xl border border-gold-500/20 bg-black/50">
                        ...
                        <div className="border-t border-gold-500/10 bg-black/70 px-5 py-4">
                            {error && (
