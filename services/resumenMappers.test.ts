...
const e = buildEmbudo({ leads_nuevos: 310, primer_mensaje: 310, respondieron: 124, interesados: 58, agendo: 30, venta_cerrada: 12, venta_perdida: 22, tiempo_resp_mediana_min: 18 } as any);
console.assert(e[2].star === true && e[2].count === 124, 'embudo star');
console.assert(e[4].id === 'agendo' && e[4].count === 30, 'embudo agendo');
